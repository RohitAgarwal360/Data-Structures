...
void displayr(PNODE first)				//go to end come back show ll in reverse
{
	printf("                                      LL->");
...
{	
	...
	while(1)
	{
			...
			printf("============================================================\n");
		printf("1.Add  At Beginning\n2.Add at END\n3.add at pos\n4.delete at beg\n5.delete at end\n6.delatpos\n7.Show Linklist Forward\n8.Show Linklist backward\n");
		scanf("%d",&choice);
		...
		switch(choice)
		{
			...
			case 7: displayf(head);
					break;

			case 8: displayr(head);
					break;

			default: printf("ERR:Wrong choice");		
		}
